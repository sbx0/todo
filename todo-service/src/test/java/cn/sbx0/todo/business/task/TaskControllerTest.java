                ...
                .andDo(
                        document("TaskSave",
                                requestFields(
                                        ...
                                        fieldWithPath("reminderTime").description("Reminder Time"),
                                        fieldWithPath("categoryId").description("Category Id"),
                                        fieldWithPath("prevId").description("Prev Id"),
                                        fieldWithPath("nextId").description("Next Id"),
                                ...
                                responseFields(
                                        ...
                                        fieldWithPath("data.reminderTime").description("Reminder Time"),
                                        fieldWithPath("data.categoryId").description("Category Id"),
                                        fieldWithPath("data.prevId").description("Prev Id"),
                                        fieldWithPath("data.nextId").description("Next Id"),
                                        fieldWithPath("data.position").description("Position"),
                                        fieldWithPath("data.createTime").description("Create Time"),
                                        fieldWithPath("data.updateTime").description("Update Time"),
                                        fieldWithPath("data").description("Data"),
                                        fieldWithPath("success").description("Is success"),
